...
import com.example.demo.db.RethinkDBConnectionFactory;
...
public class ChatController {
    ...
    public ChatMessage postMessage(@RequestBody ChatMessage chatMessage) {
        ...
        HashMap run = r.db("log").table("messages").insert(chatMessage)
    ...
    public List<ChatMessage> getMessages() {
        ...
        List<ChatMessage> messages = r.db("log").table("messages")
